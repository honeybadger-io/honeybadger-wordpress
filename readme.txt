...
Yes, you can configure additional options such as the endpoint, environment name, excluded exceptions and more. Currently these options need to be set manually in `src/class_wp_honeybadger.php`. In future versions, more of these options will be configurable through the Honeybadger Settings page in WordPress.
